SUMMARY:
This is a data collection project that takes a topic we choose and displays the data through python, I decided to make a GUI using PySide6 to showcase the data in an easier format.
